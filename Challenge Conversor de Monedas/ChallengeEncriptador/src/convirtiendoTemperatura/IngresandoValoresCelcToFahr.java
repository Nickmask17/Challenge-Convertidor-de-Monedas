...
public class IngresandoValoresCelcToFahr extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					IngresandoValoresCelcToFahr frame = new IngresandoValoresCelcToFahr();
	 ...
	 * Create the frame.
	 */
	public IngresandoValoresCelcToFahr() {
		...
		JLabel lblNewLabel = new JLabel("Ingrese el valor °C");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent evento) {
				if(textField.getText().isBlank()) {
					...
					celciusAFahrenheit(valorIngresado);
					dispose();
	...
	public double celciusAFahrenheit(double valorIngresado) { 									//Se convierte de celcius a fahrenheit

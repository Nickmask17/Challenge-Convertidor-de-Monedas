...
public class IngresandoValoresExtranjeroToLocal extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					IngresandoValoresExtranjeroToLocal frame = new IngresandoValoresExtranjeroToLocal();
	 ...
	 * Create the frame.
	 */
	public IngresandoValoresExtranjeroToLocal() {
	...
	public double ExtranjeroAColones() { 									//Se convierte de monedas extranjeras a la moneda local
		resultado = valorIngresado*factorConversion;
